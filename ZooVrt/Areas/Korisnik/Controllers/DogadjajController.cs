...
namespace ZooVrt.Areas.Korisnik.Controllers
{
    public class DogadjajController : Controller
    {
        ...
        // GET: Korisnik/Dogadjaj
        public async Task<ActionResult> Index()
        {
            return View(await db.Dogadjaji.ToListAsync());
        }

        // GET: Korisnik/Dogadjaj/Details/5
        ...
        // GET: Korisnik/Dogadjaj/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: Korisnik/Dogadjaj/Create
        ...
        // POST: Korisnik/Dogadjaj/Delete/5
